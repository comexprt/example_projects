      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		...
		<h4><i class="glyphicon glyphicon-file"></i><a href="<?php echo base_url();?>WMS/Purchase_Request" title="List of Pre-PR Request" style="color:#004D40;padding-left:5px;font-size:15px;">Purchase Request</a></i>	
			...
			<a style="color:#004D40;padding-left:5px;font-size:16px;"><?php echo "PR-".$Date_Purchased;?></a>
          	...
          	<div class="row">
						...
						<div style="width:90%;margin-left:5%;">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1">
										...
										<div class="spare-right-purpose">
											<p>: <?php echo date('F d , Y',strtotime($Date_Purchased));?><p>
										</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1" style="margin-top:10px;">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1 spare-new-left-button" style="margin-top:10px;">
							...
							<?php if( $row->PR_Status != "Scheduled for Bidding"){ ?>
									<button class="btn btn-lg" style="font-size:20px;border-radius:8px;float:right" title="PR Approval" data-toggle="modal" data-target="#<?php echo $row->PR_Date;?>Accept">
									<i class="glyphicon glyphicon-remove"></i>
									<span>Cancel</span>
									</button>
									<button class="btn btn-lg" style="font-size:20px;border-radius:8px;float:left" title="Add to Bidding" data-toggle="modal" data-target="#<?php echo $row->PR_Date;?>Bid">
									 <i class="glyphicon glyphicon-stats"></i>
									<span>Bid</span>
									</button>												
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1 spare-new-left-button" style="margin-top:5px;">
							...
							<?php
							echo $row->PR_responsible_person; ?>
							</button>
						</div><!-- col-lg-4 -->
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1 spare-new-left-button" style="margin-top:5px;">
							...
							<?php 
								if (date('F d , Y',strtotime($row->PR_Date_Changed))== "January 01 , 1970"){
								echo "";
								}else{
							echo date('F d , Y',strtotime($row->PR_Date_Changed))." - ".date('h:i A', strtotime($row->PR_Date_Changed));
								}
							?>
							</button>
						</div><!-- col-lg-4 -->
...
<?php foreach ($draft3 as $row){?>			
			<div class="modal fade" id="<?php echo $row->PR_Date;?>Bid" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<div class="modal-content">
						...
						<div class="modal-body" style="font-size:12px;color:#00271D;">
							...
							<div class="row">
								...
								<input  type="hidden" value="<?php  echo $row->PR_Date;?>" name="PR_Date">
...
<?php foreach ($draft3 as $row){?>			
			<div class="modal fade" id="<?php echo $row->PR_Date;?>Accept" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog" style="width:25%;">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
