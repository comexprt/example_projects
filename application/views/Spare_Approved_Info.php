                  ...
                  <li class="sub-menu">
				   ...
				   <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="<?php echo base_url();?>WMS/Request_Approved">Approved
						  </a>
						  </li>
                      </ul>
                  </li>
                                    ...
                                    <tbody>
									 ...
									 foreach ($SpareInfo as $row){ ?>
                                        <tr>
											...
											<td>
											<?php if ($row->Qty_Release == 0){?>
											<center><a href="#" class="btn btn-sm" title="Release Spares" data-toggle="modal" data-target="#<?php echo $row->WSid;?>release1"><i class="glyphicon glyphicon-edit" style="color:#004d40;font-size:14px;"> Release</i></a></center>
 											<?php }else{ ?>
											<p>
											<center><span style="font-weight:bold;font-size:12px;" class="fa fa-check"></span>
											</center></p>
											<?php } ?>
											</td>
								...
								<div class='col-md-12'>
									...
									<div style="margin-left:1%;margin-top:8px;">
										...
										<label style="font-size:13px;padding-left:15px;"><?php 
											$total = $row->Quantity_onHand + $row->Qty_Release;
									...
									<div style="margin-left:1%;margin-top:8px;margin-bottom:14px;font-size:12px;">
										...
										<br>
										<label style="font-size:13px;padding-left:15px;"><?php echo $row->Qty_Release." ".$row->Unit_Of_Measurement;?></label>
										<br>
									...
									<div style="margin-left:1%;margin-top:8px;margin-bottom:14px;font-size:12px;">
										...
										<br>
										<input type="number" class="form-control"  value="<?php echo $row->Qty_Requested;?>" name="Qty_Release" min="1" max="<?php echo $row->Qty_Release;?>"required/>
										<br>
							...
							<div class="row">
								...
								<div class='col-md-12'>
									...
									<div style="margin-left:1%;margin-top:8px;margin-bottom:14px;font-size:12px;">
										...
										<label style="font-size:13px;font-weight:bold;">Quantity Release</label>
										<br>
										<input type="number" class="form-control"  value="<?php echo $row->Qty_Requested;?>" name="Qty_Release" min="0" max="<?php echo $row->Qty_Release + $row->Quantity_onHand ;?>"required/>
										<br>
