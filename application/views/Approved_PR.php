                               ...
                               <table class="table table-striped table-advance table-hover" id="dataTables-Requested">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="spareitems">
											...
											<?php if( $row->PR_Status == "Approved PR"){ ?>
												<span class="label label-success" style="font-size:12px;"><?php echo $row->PR_Status; ?></span>
												
											
										    <?php }else{ ?>
											<span class="label label-danger" style="font-size:12px;"><?php echo $row->PR_Status; ?></span>
											<?php }?>
											...
											<td style="text-indent:20px;"><span 	style="font-size:12px;"><?php echo date('F d , Y',strtotime($row->PR_Date_Changed))." - ".date('h:i A', strtotime($row->PR_Date_Changed)); ?></span></td>
