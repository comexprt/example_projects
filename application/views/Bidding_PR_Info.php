				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1" style="margin-top:10px;">
                                    ...
                                    <thead>
                                        <tr>
											  ...
											  <th style="border:1px solid #24665B;"><center>UM</center></th>
											  <th style="border:1px solid #24665B;"><center><i class="glyphicon glyphicon-stats"></i> BIDS</center></th>
										</tr>
                                    </thead>
                                    <tbody>
									 ...
									 foreach ($SpareInfo as $row){ ?>
                                        <tr>
										   ...
										   <div>
											...
											<form method="post" action="<?php echo base_url();?>WMS/Bidding_Item_Info">
												<input  type="hidden" value="<?php echo $row->SpId;?>" name="SpId">
												<input  type="hidden" value="<?php echo $row->WSid;?>" name="WSid">
												<input  type="hidden" value="<?php echo $DceNo1;?>" name="DceNo">
												<input  type="hidden" value="<?php echo $BId;?>" name="BId">
												<button type="submit" class="btn btn-link btn-link-modal" style="text-decoration:none;" title="View Bidding Quotations"> 
												  <i class="glyphicon glyphicon-search" style="color:#004d40;font-size:14px;"> View </i>
												</button>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1" style="text-align:right;padding-right:17%;margin-top:0px;font-size:14px">
...
<?php }?>
	...
	<?php foreach ($bidding_spare_purchase as $row){?>	
			...
			<div class="modal fade" id="<?php echo $row->WSid;?>bidding" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog" style="width:25%;">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						    <h4 class="modal-title" id="myModalLabel">Bidding Quotations</h4>
						</div>
						...
						<div class="modal-body" style="font-size:12px;color:#00271D;">
							...
							<div class="row">
								...
								<input  type="hidden" value="<?php  echo $row->Purpose;?>" name="Purpose">
								<input  type="hidden" value="<?php  echo $row->OIC;?>" name="Oic">
								<input  type="hidden" value="Bidding PR" name="Status">
								<input  type="hidden" value="<?php  echo $row->DceNo;?>" name="DceNo">
								<input  type="hidden" value="<?php  echo $row->Date_Needed;?>" name="Date_Needed">
								<?php $dc=time();?>
								<input  type="hidden" value="<?php  echo date('F d ,Y',$dc);?>" name="Date_Status_Changed">
