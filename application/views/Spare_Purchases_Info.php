          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
				 ...
				 <li class="sub-menu">
                  ...
                  <li class="sub-menu">
                      <a href="<?php echo base_url();?>WMS/Spare_Purchases" class="active">
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="EndUser_ws.html">Statics</a></li>
                      </u>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        <section class="wrapper site-min-height">
          	<h4><i class="glyphicon glyphicon-shopping-cart"></i><a href="<?php echo base_url();?>WMS/Spare_Purchases" title="List of Purchase Request" style="color:#004D40;padding-left:5px;font-size:15px;">Purchase Request</a>
			<i class="fa fa-angle-double-left" style="padding-left:5px;"></i>
			<a style="color:#004D40;padding-left:5px;font-size:16px;">LIST</a>
			<i class="fa fa-angle-double-left" style="padding-left:5px;"></i>
                                        ...
                                        <tr>
											...
											<?php 
												...
												if($det_status == "Quoted"){ ?>
													<center>
														<p>
															<span class="label label-success" style="font-weight:bold;font-size:12px;text-transform:uppercase;"><?php echo $Status; ?></span>
														</p>
													</center>
												...
												<?php }else{ ?>
													<center>
														<p>
															<span class="label label-info" style="font-weight:bold;font-size:12px;text-transform:uppercase;"><?php echo $Status; ?></span>
														</p>
													</center>
												<?php }?>
