                                    ...
                                    <tbody>
									 ...
									 foreach ($SpareInfo as $row){ ?>
                                        <tr>
                                            ...
                                            <td style="border:1px solid #24665B;font-weight:bold"><center><?
											 $i = $i + 1;
											echo $i;?></center></td>
											...
											<td style="border:1px solid #24665B;">
												<center><a href="#" data-toggle="modal" data-target="#<?php echo $row->WSid;?>UpdateSpare" title="Update Quantity Request"><i style="font-size:18px;color:#004D40" class="glyphicon glyphicon-credit-card"></i></a></center>
							...
							<div class="row">
								...
								<div class='col-md-12'>
									...
									<div style="margin-left:1%;margin-top:8px;">
										...
										<p style="text-left:15px;font:18px"><span class="label label-danger"> Out Of Stock</span></p>
