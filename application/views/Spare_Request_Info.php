			...
			<?php }?>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1" style="margin-top:10px;">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1 spare-new-left-button" style="margin-top:10px;">
							<button class="btn btn-lg" style="font-size:20px;border-radius:8px;float:right" title="Send Pre-PR DRAFT for Approval" data-toggle="modal" data-target="#<?php echo $row->WRId;?>update">
							UPDATE
							</button>
						</div><!-- col-lg-4 -->
							...
							<div class="row">
								...
								<div class='col-md-12'>
									 ...
									 <div style="padding-top:0%;width:40%;float:left;">
										...
										<button type="button" style="font-size:15px;float:left;margin-left:10%;" class="btn btn-default" data-dismiss="modal" data-toggle="modal" data-target="#<?php echo $row->WRId;?>Decline">
											Decline
										</button>
									</div>
								</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body" style="font-size:12px;color:#00271D;">
							...
							<div class="row">
								...
								<input  type="hidden" value="<?php  echo $row->Date_Requested;?>" name="Date_Requested">
								...
								<div class='col-md-12'>
									<div style="margin-left:1%;margin-top:8px;margin-bottom:12px;">
										...
										<label style="font-size:14px;font-weight:bold;">Are you sure to Approve Spares Request? </label>
									</div>
