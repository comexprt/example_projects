                                ...
                                <table class="table table-striped table-advance table-hover" id="dataTables-Requested">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>REMARKS</th>
											    <th class="hidden-phone" ><i class="fa fa-calendar"></i> Date/Time REQUESTED</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="spareitems">
											...
											<?php echo date('F d , Y',strtotime($row->Date_Requested))." - ".date('h:i A', strtotime($row->Date_Requested))?>
											</td>
